# oriz-envpact-dashboard-app — agent guide
...
- Deploy: `astro build && wrangler pages deploy dist --project-name oriz-envpact-dashboard-app --branch main --commit-dirty=true`.
